...
void CS2ADatabase::CreateSchema()
{
	...
	if (IsSQLite())
	{
		...
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_bans_sid ON %s_bans (sid)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_bans_type_authid ON %s_bans (type, authid)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_bans_type_ip ON %s_bans (type, ip)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		...
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_sid ON %s_comms (sid)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_type ON %s_comms (type)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_authid ON %s_comms (authid)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_created ON %s_comms (created)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_RemoveType ON %s_comms (RemoveType)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		snprintf(query, sizeof(query), "CREATE INDEX IF NOT EXISTS idx_%s_comms_aid ON %s_comms (aid)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		...
		snprintf(query, sizeof(query), "CREATE UNIQUE INDEX IF NOT EXISTS idx_%s_admins_user ON %s_admins (user)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		...
		snprintf(query, sizeof(query), "CREATE UNIQUE INDEX IF NOT EXISTS idx_%s_sgo_gtn ON %s_srvgroups_overrides (group_id, type, name)", prefix,
				 prefix);
		Query(query, [](ISQLQuery *) {});
		...
		snprintf(query, sizeof(query), "CREATE UNIQUE INDEX IF NOT EXISTS idx_%s_overrides_tn ON %s_overrides (type, name)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
		...
		snprintf(query, sizeof(query), "CREATE UNIQUE INDEX IF NOT EXISTS idx_%s_servers_ip_port ON %s_servers (ip, port)", prefix, prefix);
		Query(query, [](ISQLQuery *) {});
